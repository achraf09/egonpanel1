...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('birthdate', trans('quickadmin.users.fields.birthdate').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($user->profilphoto)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$user->profilphoto) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$user->profilphoto) }}"></a>
                    @endif
                    {!! Form::label('profilphoto', trans('quickadmin.users.fields.profilphoto').'', ['class' => 'control-label']) !!}
                    {!! Form::hidden('profilphoto', old('profilphoto')) !!}
                    {!! Form::file('profilphoto', ['class' => 'form-control', 'style' => 'margin-top: 4px;']) !!}
                    {!! Form::hidden('profilphoto_max_size', 2) !!}
                    {!! Form::hidden('profilphoto_max_width', 4096) !!}
                    {!! Form::hidden('profilphoto_max_height', 4096) !!}
                    <p class="help-block"></p>
                    @if($errors->has('profilphoto'))
                        <p class="help-block">
                            {{ $errors->first('profilphoto') }}
                        </p>
                    @endif
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('group_id', trans('quickadmin.users.fields.group').'', ['class' => 'control-label']) !!}
