...
@section('content')
    ...
    @can('supplier_create')
    <p>
        <a href="{{ route('admin.suppliers.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
    ...
    <p>
        <ul class="list-inline">
            <li><a href="{{ route('admin.suppliers.index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">Alles</a></li> |
            <li><a href="{{ route('admin.suppliers.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">Papierkorb</a></li>
        </ul>
    </p>
    @endcan
